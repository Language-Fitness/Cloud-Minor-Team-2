...
$randomQueryParam = Get-Random -Minimum 10000 -Maximum 99999

# Set your GitHub repository details

$githubRepo = "https://github.com/BramTerlouw/Cloud-Minor-Team-2"
$filePathOnGitHub = "proto/resultProto.proto?$randomQueryParam"
...
Write-Host "Generating Go code using protoc"S
