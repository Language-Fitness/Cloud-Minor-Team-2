...
class TestAssistantAPIAdapter(unittest.TestCase):
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.load_assistant')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_assistant')
    def test_generate_multiple_choice__create_assistant_failure_exception(self, mock_create_assistant, mock_load_assistant):
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.load_assistant')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_assistant')
    def test_generate_multiple_choice__create_assistant_failure_assistant_api_exception(self, mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_assistant')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_thread')
    def test_generate_multiple_choice__create_thread_failure_assistant_api_exception(self, mock_create_thread, mock_create_assistant,
                                                           mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_thread')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_message')
    def test_generate_multiple_choice__create_message_failure_assistant_api_exception(self, mock_create_message, mock_create_thread,
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_thread')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_message')
    def test_generate_multiple_choice__create_message_failure_exception(self, mock_create_message, mock_create_thread, mock_create_assistant,
                                              mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_message')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.run_thread')
    def test_generate_multiple_choice__run_thread_failure_assistant_api_exception(self, mock_run_thread, mock_create_message, mock_create_thread,
                                                        mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_message')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.run_thread')
    def test_generate_multiple_choice__run_thread_failure_exception(self, mock_run_thread, mock_create_message, mock_create_thread,
                                          mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.run_thread')
    @patch('services.openai.assistant_api_adapter.AssistantAPIAdapter.encode_token')
    def test_generate_multiple_choice__encode_token_failure(self, mock_encode_token, mock_run_thread, mock_create_message, mock_create_thread,
                                  mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
    ...
    def test_generate_explanation__load_assistant_failure_exception(self, mock_load_assistant):
        mock_load_assistant.side_effect = Exception("Load assistant failure")
        with self.assertRaises(Exception):
            self.assistantAPIAdapter.generate_explanation("Woordenschat", "wat doe je als je ‘een oogje in het zeil houdt’?", "je bent op zoek naar een specifiek zeilschip", "je let goed op om te zorgen dat alles goed gaat")
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.load_assistant')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_assistant')
    def test_generate_explanation__create_assistant_failure_assistant_api_exception(self, mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.side_effect = AssistantAPIException(
            "Request could not be fulfilled. Please provide an valid OpenAI API key in CMS.")
        with self.assertRaises(AssistantAPIException):
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_assistant')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_thread')
    def test_generate_explanation__create_thread_failure_exception(self, mock_create_thread, mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.side_effect = Exception("An unexpected error occurred while creating thread.")
        with self.assertRaises(Exception):
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_assistant')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_thread')
    def test_generate_explanation__create_thread_failure_assistant_api_exception(self, mock_create_thread, mock_create_assistant,
                                                           mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.side_effect = AssistantAPIException(
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_thread')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_message')
    def test_generate_explanation__create_message_failure_assistant_api_exception(self, mock_create_message, mock_create_thread,
                                                            mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_thread')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_message')
    def test_generate_explanation__create_message_failure_exception(self, mock_create_message, mock_create_thread, mock_create_assistant,
                                              mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_message')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.run_thread')
    def test_generate_explanation__run_thread_failure_assistant_api_exception(self, mock_run_thread, mock_create_message, mock_create_thread,
                                                        mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.create_message')
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.run_thread')
    def test_generate_explanation__run_thread_failure_exception(self, mock_run_thread, mock_create_message, mock_create_thread,
                                          mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
    ...
    @patch('services.openai.openai_assistant_manager.OpenAIAssistantManager.run_thread')
    @patch('services.openai.assistant_api_adapter.AssistantAPIAdapter.encode_token')
    def test_generate_explanation__encode_token_failure(self, mock_encode_token, mock_run_thread, mock_create_message, mock_create_thread,
                                  mock_create_assistant, mock_load_assistant):
        mock_load_assistant.return_value = MagicMock()
        mock_create_assistant.return_value = MagicMock()
        mock_create_thread.return_value = MagicMock()
