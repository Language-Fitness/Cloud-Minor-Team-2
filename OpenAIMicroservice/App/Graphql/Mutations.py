...
class GenerateOpenAnswerQuestions(graphene.Mutation):
    ...
    # The return fields for the mutation
    thread_id = graphene.String()

    # The mutate method is called when the mutation is executed
...
# The ObjectType for mutations should reference the mutation classes without instantiation
