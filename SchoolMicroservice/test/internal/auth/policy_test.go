...
func TestCreateSchoolWithAdminToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)

	schoolPolicy := auth.Policy{
		SchoolRepository: mockRepo,
		Token:            mockToken,
	}
	...
	_, err := schoolPolicy.CreateSchool(adminToken)
...
func TestCreateSchoolWithTeacherToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.CreateSchool(teacherToken)
...
func TestCreateSchoolWithStudentToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.CreateSchool(studentToken)
...
func TestUpdateSchoolWithAdminToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.UpdateSchool(adminToken, "3a3bd756-6353-4e29-8aba-5b3531bdb9ed")
...
func TestUpdateSchoolWithTeacherToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
...
func TestUpdateSchoolWithStudentToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.UpdateSchool(studentToken, "3a3bd756-6353-4e29-8aba-5b3531bdb9ed")
...
func TestDeleteSchoolWithAdminToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.DeleteSchool(adminToken, "3a3bd756-6353-4e29-8aba-5b3531bdb9ed")
...
func TestDeleteSchoolWithTeacherToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.DeleteSchool(teacherToken, "3a3bd756-6353-4e29-8aba-5b3531bdb9ed")
...
func TestDeleteSchoolWithStudentToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.DeleteSchool(studentToken, "3a3bd756-6353-4e29-8aba-5b3531bdb9ed")
...
func TestGetSchoolWithAdminToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.GetSchool(adminToken, "3a3bd756-6353-4e29-8aba-5b3531bdb9ed")
...
func TestGetSchoolWithStudentTeacherToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.GetSchool(teacherToken, "3a3bd756-6353-4e29-8aba-5b3531bdb9ed")
...
func TestGetSchoolWithStudentToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	_, err := schoolPolicy.GetSchool(studentToken, "3a3bd756-6353-4e29-8aba-5b3531bdb9ed")
...
func TestListSchoolsWithAdminToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	err := schoolPolicy.ListSchools(adminToken)
...
func TestListSchoolsWithStudentTeacherToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
	...
	err := schoolPolicy.ListSchools(teacherToken)
...
func TestListSchoolsWithStudentToken(t *testing.T) {
	mockRepo := new(mocks.MockRepository)
	mockToken := new(mocks.MockToken)
